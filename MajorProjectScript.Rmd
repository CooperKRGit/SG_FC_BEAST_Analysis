...
xlocs = c( 1751997, 1752065, 1752256, 1752281, 1752102, 1751912, 1751138, 1751368, 1751878, 1752186)
ylocs = c( -3852258, -3852333, -3852504, -3852601, -3852470, -3852346, -3852129, -3852571, -3852677, -3852484)
# The first 3 are in the swampland of Spring Gully itself, the second 3 are of the tree canopy surrounding the swampland of Spring Gully, the third three are from vegetated areas further from Spring Gully but still within the Spring Gully SFAZ region defined in the RNP Fire Management Strategy.
...
for (i in 1:ncol(vals)) {
  ...
  b$time = dates  #  ensure plots display times
  plot(
     b, 
     index = 1,
